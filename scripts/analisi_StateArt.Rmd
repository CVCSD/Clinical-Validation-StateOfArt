...
webshot::webshot("wordcloud.html", file="../outputs/wordcloud.png", delay = 5, vwidth = 1000, vheight = 1000)
...
![](../outputs/wordcloud.png){width=400% height=400% }
...
webshot("tmp2.html", "../outputs/wc2.png", delay = 5, vwidth = 1000, vheight = 1000)
...
![](../outputs/wc2.png){width=400% height=400% }
...
officer::read_docx(path_docs) %>% 
  officer::body_add_img("../outputs/wordcloud.png",height = 5, width = 5) %>% 
  print(target = path_docs)  


officer::read_docx(path_docs) %>% 
  officer::body_add_img("../outputs/wc2.png",height = 5, width = 5) %>% 
  print(target = path_docs)  
...
dt_temp2<-dt_temp2 %>% bind_rows(dt_temp3) %>% arrange(PUBYEAR,Quartil) %>% 
  filter(PUBYEAR<2024 & PUBYEAR>2005)
...
# title = "Frequency Map of Papers by Countries Worldwide"
...
ggsave(here::here("outputs","fig2B.tiff"), fig3,dpi = 300,limitsize = 1000)

ggsave(here::here("outputs","fig2A.png"), fig4)
ggsave(here::here("outputs","fig2A.tiff"), fig4, dpi = 300,limitsize = 1000)

ggsave(here::here("outputs","fig3A.png"),gg_map2)
ggsave(here::here("outputs","fig3A.tiff"),gg_map2, dpi = 300,limitsize = 1000)

ggsave(here::here("outputs","fig3A_regions.png"),gg_map1)
ggsave(here::here("outputs","fig3A_regions.tiff"),gg_map1,dpi = 300,limitsize = 1000)

htmlwidgets::saveWidget(world_cloud_keywords, "wordcloud.html", selfcontained = F)
webshot::webshot("wordcloud.html", file=here::here("outputs","wordcloud.png"), delay = 5, vwidth = 1000, vheight = 1000)

# Leer arxivos i guardar en Tiff 
mi_captura <- png::readPNG(here::here("outputs","wordcloud.png"))
tiff::writeTIFF(mi_captura, here::here("outputs","wordcloud.tiff"))



# htmlwidgets::saveWidget(world_cloud_keywords, "wordcloud.html", selfcontained = F)
# webshot::webshot("wordcloud.html", file=here::here("outputs","wordcloud.tiff"), delay = 5, vwidth = 1000, vheight = 1000)
# 
# htmlwidgets::saveWidget(world_cloud_keywords, "wordcloud.html", selfcontained = F)
# webshot::webshot("wordcloud.html", file=here::here("outputs","wordcloud.ps"), delay = 5, vwidth = 1000, vheight = 1000)
