...
The search provided a total of 1250 papers. In the Wordcloud, it can be observed that the most frequent keywords refer to mobile health, eHealth, and validation. Out of the total 1250 papers, epidemiological designs were identified in 449 of them, of which 40% were classified as clinical trials, while the rest were observational studies or systematic reviews. Among the works where the epidemiological design was identified, 55.3% were observational.

Of all the references found, the most frequent dimension was Usability (n=222, 17.8%), followed by Security (14.2%), and Feasibility (10.0%).
...
The authors who publish the most are mainly from the United States (25%), followed by European countries such as the UK (7.53%), Spain, Germany, and Australia (7.53%).
...
formu<-formula_text("Baseline","",taulavariables = path_conductor)
...
files_clean<-c("temp1.docx","temp2.docx","temp3.docx","temp1.Rmd","temp2.Rmd","temp3.Rmd")
