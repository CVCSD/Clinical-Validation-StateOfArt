...
dades_extra<-read.csv2(here::here("data","objects.txt"), sep="#",encoding = "UTF-8")
...
#Termes ehealth
dt_clinical_trials<-read.csv2(here::here("data/clinicaltrials","ctg-studies.csv"), sep = ",")

# Cerca termes ehealth OR.... Gontiveiros
dt_clinical_trials<-read.csv2(here::here("data/clinicaltrials","SearchResults.csv"), sep = ",")
